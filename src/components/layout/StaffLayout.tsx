...
const sidebarItems = [
  ...
  { icon: ShoppingCart, label: 'My Bookings', path: '/staff/bookings' },
  { icon: TicketIcon, label: 'My Tickets', path: '/staff/tickets' },
    ...
    <div className="min-h-screen bg-background flex">
      ...
      >
        ...
        <div className="flex items-center gap-3 p-4 border-b border-sidebar-border">
          ...
          {sidebarOpen && (
            ...
            >
              ...
              <span className="text-xs text-sidebar-foreground/60">Staff Panel</span>
            </motion.div>
          )}
        </div>
          ...
          <div className={cn('flex items-center gap-3', sidebarOpen ? '' : 'justify-center')}>
            ...
            {sidebarOpen && (
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-sidebar-foreground/60">Staff Member</p>
              </div>
            )}
          </div>
          <Button
        ...
        <button
          ...
          className="absolute -right-3 top-20 w-6 h-6 rounded-full bg-emerald-500 text-white flex items-center justify-center shadow-md hover:scale-110 transition-transform"
        >
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-sidebar text-sidebar-foreground z-40 flex items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <span className="font-display font-bold">ZappTek Staff</span>
        </div>
